...
class VerificationAPIController extends Controller
{
    ...
    public function verificationAPI($id=null){
        if($id){
            $verifications = DB::table('verifications')
            ->join('user_tbl', 'verifications.user_id', '=', 'user_tbl.userID')
            ->select('user_tbl.firstName as firstName', 'user_tbl.lastName as lastName', 'user_tbl.userID as userID', 'user_tbl.email as email', 'user_tbl.phone as phone', 'user_tbl.verified as verified', 'verifications.id as veriID', 'verifications.employment_status as employment_status', 'verifications.verification_id as verification_id', 'verifications.created_at as verifications_date', 'verifications.gross_annual_income as gross_annual_income', 'verifications.created_at as created_at', 'verifications.marital_status as marital_status', 'verifications.present_address as present_address', 'verifications.duration_present_address as duration_present_address', 'verifications.disability as disability', 'verifications.pets as pets', 'verifications.present_landlord as present_landlord', 'verifications.landlord_email as landlord_email', 'verifications.landlord_phone as landlord_phone', 'verifications.landlord_address as landlord_address', 'verifications.dob as dob', 'verifications.occupation as occupation', 'verifications.company_name as company_name', 'verifications.company_address as company_address', 'verifications.hr_manager_name as hr_manager_name', 'verifications.hr_manager_email as hr_manager_email', 'verifications.office_phone as office_phone', 'verifications.current_renting_status as current_renting_status', 'verifications.reason_for_living as reason_for_living', 'verifications.guarantor_name as guarantor_name', 'verifications.guarantor_email as guarantor_email', 'verifications.guarantor_phone as guarantor_phone', 'verifications.guarantor_address as guarantor_address', 'verifications.guarantor_occupation as guarantor_occupation')
            ->where('verifications.id',$id)
            ->orderBy('verifications.id','desc')
            ->get();
        }else {
    ...
    public function tenantVerification(){
        if($id){
            $tenantVerification = DB::table('verifications')
            ->join('user_tbl', 'verifications.user_id', '=', 'user_tbl.userID')
            ->select('user_tbl.firstName as firstName', 'user_tbl.lastName as lastName', 'user_tbl.email as email', 'user_tbl.phone as phone', 'user_tbl.verified as verified', 'verifications.employment_status as employment_status', 'verifications.verification_id as verification_id', 'verifications.created_at as verifications_date', 'verifications.gross_annual_income as gross_annual_income', 'verifications.created_at as created_at')
            ->where('id',$id)
            ->orderBy('verifications.id','desc')
            ->get();
        }else {
...
//         //$update = DB::table('verifications')->where('id', $request->id)->update($data);
...
//     }
    ...
    public function updateVerificationStatusAPI(Request $request)
    {
        ...
        if ($update) {
                            ...
                            <table width='100%' style='margin-top:30px'>
                                <tr>
                                    <td width='100%'>
                                        <div class='message-container' style='width:100%;border-radius:10px;text-align:center;background:#F2FCFB;padding:40px;'>
                                            <div style='width:100%;	min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:30px;margin-bottom:20px;' class='name'>Hello, $firstName</div>
                                            <div style='width:100%;min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:20px;margin-bottom:20px;' class='intro'>Verification Successful</div>
                                            ...
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>Please note: If payment is not made within 12 hours, the property will be available for the next person in the queue. Also, if payment is made after the stipulated time, the process of initiating a refund takes 7 days or a sum of two thousand naira (N2000) will be charged for an immediate refund. If you choose to cancel your booking, a 5% deduction would be applied.</div>
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>Subscription payment is easy on our platform, we use Paystack to collect payments on a modern secure payment gateway, this gateway offers users different modes of payment.  Smallsmall does not store bank card or personal account data.
                                                If you encounter any problem using the payment gateway please contact Smallsmall Customer experience at customerexperience@smallsmall.com or Call 070-877 89 815/ 0903-722-2669/ 0903-633-9800 for assistance.
                                                Thanks
                                            </div>
            ...
            }elseif($data['verified'] == 'processing'){
                            ...
                            <table width='100%' style='margin-top:30px'>
                                <tr>
                                    <td width='100%'>
                                        <div class='message-container' style='width:100%;border-radius:10px;text-align:center;background:#F2FCFB;padding:40px;'>
                                            <div style='width:100%;	min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:30px;margin-bottom:20px;' class='name'>Hello, $firstName</div>
                                            <div style='width:100%;min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:20px;margin-bottom:20px;' class='intro'>Verification in process</div>
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>This is to notify you that verification processing has begun, and you will be notified as soon as a decision has been made.
</div>
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>Please note your information is highly confidential.</div>
                            ...
                            <table width='100%' style='margin-top:30px'>
                                <tr>
                                    <td width='100%'>
                                        <div class='message-container' style='width:100%;border-radius:10px;text-align:center;background:#F2FCFB;padding:40px;'>
                                            <div style='width:100%;	min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:30px;margin-bottom:20px;' class='name'>Hello, $firstName</div>
                                            <div style='width:100%;min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:20px;margin-bottom:20px;' class='intro'>Verification Received</div>
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>Your verification details have been received, you will get another email in 48 hours notifying you of actions been taken towards verifying your details.</div>
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>Please note your information is highly confidential.</div>
                            ...
                            <table width='100%' style='margin-top:30px'>
                                <tr>
                                    <td width='100%'>
                                        <div class='message-container' style='width:100%;border-radius:10px;text-align:center;background:#F2FCFB;padding:40px;'>
                                            <div style='width:100%;	min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:30px;margin-bottom:20px;' class='name'>Hello, $firstName</div>
                                            <div style='width:100%;min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:20px;margin-bottom:20px;' class='intro'>Verification Failed</div>
                                            <div style='width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:16px;margin-bottom:20px;' class='email-body'>Thank you for showing interest in renting with us. We are sorry to inform that you did not pass our verification process and are therefore not eligible to rent with us at the moment, therefore you can’t make payment.</div>
