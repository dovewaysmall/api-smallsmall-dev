...
Regards, 
    ...
    public function apartmentNotAvailable(Request $request)
    {
        ...
        if ($update) {
            ...
            $this->sendApartmentNotAvailableEmail($firstName, $propertyTitle, $to, $subject);
    ...
    public function sendApartmentNotAvailableEmail($firstName, $propertyTitle, $to, $subject)
    {
		...
		$requestBody = [
			"id" => "9fdc0f34-6996-11ee-a653-d6582e42a3ff"
		];
        ...
        try {
            ...
            $htmlBody = str_replace('{{propertyname}}', $propertyTitle, $htmlBody);
